...
func (h *handlers) Terminal(c *gin.Context) {
	...
	// Unblocks the read loop below at shutdown so the deferred
	// broker.Disconnect above runs instead of leaving the serial port held
	// open through process teardown.
